      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card card-outline card-success">
            ...
            <div class="card-body">
              <form action="{{ route('role.update', base64_encode($id)) }}" method="post">
                @csrf
                @method('put')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="display_name" id="display_name" class="form-control" placeholder="Name"
                      value="{{ $role->display_name }}" maxlength="150">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="description" id="description" class="form-control"
                      placeholder="Description" maxlength="150" value="{{ $role->description }}">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <select name="permissions[]" id="permissions" class="form-control select2" multiple="multiple">
                      ...
                      <option value="{{ $p->id }}" {{ $p->selected ? 'selected' : '' }}>{{ $p->display_name }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
